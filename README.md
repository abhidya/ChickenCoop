...
If the Unity loader appears and starts downloading the build files, the static hosting path is wired correctly. Full gameplay validation still requires opening the Unity project because WebGL build output is generated by the editor.
